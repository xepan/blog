...
class Model_Comment extends \xepan\base\Model_Table{
	...
	function approve(){
		...
		$this->app->employee
            ->addActivity("Blog Comment : '".$this['comment']."' On Blog : '".$this['blog_post_id']."' , has been approved to show on web", null/* Related Document ID*/, $this->id /*Related Contact ID*/)
	...
	function reject(){
		...
		$this->app->employee
            ->addActivity("Blog Comment : '".$this['comment']."' On Blog : '".$this['blog_post_id']."' , has been rejected", null/* Related Document ID*/, $this->id /*Related Contact ID*/)
	...
	function pending(){
		$this['status']='Pending';
		$this->app->employee
            ->addActivity("Blog Comment : '".$this['comment']."' On Blog : '".$this['blog_post_id']."' , is pending for approval", null/* Related Document ID*/, $this->id /*Related Contact ID*/)
